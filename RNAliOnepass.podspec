...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/DreamTravelingLight/react-native-ali-onepass-bnq.git"
  s.license      = "MIT"
  s.author             = { "yoonzm" => "yinzhim@gmail.com" }
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/DreamTravelingLight/react-native-ali-onepass-bnq.git", :tag => "master" }
