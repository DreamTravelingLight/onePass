 ...
 * @return {Promise<*>}
 */
export async function onePass(config,showType) {
  return await RNAliOnepass.onePass(config,showType);
}
...
export const EVENTS = {
  ...
  otherLoginTypeSelect: 'otherLoginTypeSelect',
  pageClickEvents: 'pageClickEvents',
  pageDrawSuccess:'pageDrawSuccess',
